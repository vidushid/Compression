...
int main() {
    ...
    vector<string> fa_files={"CHM13Y.fa","HG002.1.fa","HG002.2.fa","HG00438.1.fa","HG00438.2.fa","HG005.1.fa","HG005.2.fa",
	"HG00621.1.fa","HG00621.2.fa","HG00673.1.fa","HG00673.2.fa","HG00733.1.fa","HG00733.2.fa","HG00735.1.fa","HG00735.2.fa",
	"HG00741.1.fa","HG00741.2.fa","HG01071.1.fa","HG01071.2.fa","HG01106.1.fa","HG01106.2.fa","HG01109.1.fa","HG01109.2.fa",
	"HG01123.1.fa","HG01123.2.fa","HG01175.1.fa"};
	...
	unordered_map<string, vector<string>> lift1,lift2,lift3,lift4,lift5,lift6,lift7,lift8,lift9,lift10,lift11,lift12,lift13,lift14
	,lift15,lift16,lift17,lift18,lift19,lift20,lift21,lift22,lift23,lift24,lift25;


	use_liftover(paf_files,output_lift);
	//create_lifted_dict();
    unordered_map<string, int> ref_index, seq1_index, seq2_index, seq3_index, seq4_index, seq5_index, seq6_index ,seq7_index, seq8_index, 
	seq9_index, seq10_index,seq11_index,seq12_index,seq13_index,seq14_index,seq15_index,seq16_index,seq17_index,seq18_index,seq19_index,
	seq20_index,seq21_index,seq22_index,seq23_index,seq24_index,seq25_index;
	...
	//start compressing
	ofstream f("seq25c.bin",ios::out | ios :: binary);
	for(auto i:lifted){
		if(i.second.size()>0){
